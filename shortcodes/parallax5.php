...
class Parallax5 extends Shortcodes
{
	...
	static function vc_map() {
		return [
			"name" => esc_html__("Parallax Style 5", 'lifeline-donation'),
            "base" => self::$shortcode,
            ...
            "params" => array(
    			...
    			array(
    				'type'          => 'attach_image',
    				'class'         => '',
    				'heading'       => esc_html__( 'Background Image', 'lifeline-donation' ),
    				'param_name'    => 'bg_image',
    				'description'   => esc_html__( 'Upload background to show.', 'lifeline-donation' ),
    			),
                array(
                    "type" => "textfield",
                    "class" => "",
