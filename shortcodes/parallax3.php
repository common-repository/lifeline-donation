...
class Parallax3 extends Shortcodes
{
	...
	static function vc_map() {
		return [
			"name" => esc_html__("Parallax Style 3", 'lifeline-donation'),
            "base" => self::$shortcode,
            ...
            "params" => array(
                array(
    				'type'          => 'attach_image',
    				'class'         => '',
    				'heading'       => esc_html__( 'Side Image', 'lifeline-donation' ),
    				'param_name'    => 'side_image',
    				'description'   => esc_html__( 'Upload side image to show.', 'lifeline-donation' ),
    			),
                ...
                array(
                    ...
                    "param_name" => "title",
                    "description" => esc_html__("Enter the title to show", 'lifeline-donation')
                ),
                array(
                    "type" => "textarea",
                    "class" => "",
                    ...
                    "param_name" => "text",
                    "description" => esc_html__("Enter text to show", 'lifeline-donation')
                ),
            array( 
    			'type'              => 'checkbox',
    			'class'             => '',
            ...
            array(
				'type'       => 'textfield',
				'heading'    => esc_html__( 'Button 2 Label', 'lifeline-donation' ),
