...
class Orders {
	...
	public static function add_metabox() {
		...
		$title = apply_filters( 'wpcommerce_admin_orders_metabox_title', esc_html__( 'Order Detail', 'lifeline-donation' ) );
	...
	public static function register_post_type() {
		...
		$labels = array(
			'name'               => esc_html__( 'Orders', 'lifeline-donation' ),
			'singular_name'      => esc_html__( 'Order', 'lifeline-donation' ),
			'add_new'            => _x( 'Add New Order', 'webinane-commerce', 'lifeline-donation' ),
			'add_new_item'       => esc_html__( 'Add New Order', 'lifeline-donation' ),
			'edit_item'          => esc_html__( 'Edit Order', 'lifeline-donation' ),
			'new_item'           => esc_html__( 'New Order', 'lifeline-donation' ),
			'view_item'          => esc_html__( 'View Order', 'lifeline-donation' ),
			'search_items'       => esc_html__( 'Search Orders', 'lifeline-donation' ),
			'not_found'          => esc_html__( 'No Orders found', 'lifeline-donation' ),
			'not_found_in_trash' => esc_html__( 'No Orders found in Trash', 'lifeline-donation' ),
			'parent_item_colon'  => esc_html__( 'Parent Order:', 'lifeline-donation' ),
			'menu_name'          => esc_html__( 'Orders', 'lifeline-donation' ),
		);
	...
	public static function export_button(){
		...
		if( $screen->id == 'edit-orders' && $screen->post_type == 'orders' ){
			?>
				...
				var button_label = '<?php echo esc_html__('Export Orders', 'lifeline-donation'); ?>';
	...
	public static function register_pages() {
		...
		self::$export_page = add_submenu_page(
	        ...
	        esc_html__( 'Export Orders', 'lifeline-donation' ),
	        esc_html__('Export Orders', 'lifeline-donation' ),
	        'manage_options',
	...
	public static function export_page() {
		...
		<div class="wrap wpcommerce">
			<h1><?php esc_html_e( 'Export Orders', 'lifeline-donation' ); ?></h1>
			<div class="wpcommerce-exporter-wrapper">
				<form class="wpcommerce-exporter">
					<header>
						<h2><?php esc_html_e( 'Export orders to a CSV file', 'lifeline-donation' ); ?></h2>
						<p><?php esc_html_e( 'This tool allows you to generate and download a CSV file containing a list of all orders.', 'lifeline-donation' ); ?></p>
					</header>
					<section>
						<table class="form-table wpcommerce-exporter-options">
							<tbody>
								<tr>
									<th scope="row">
										<label for="wpcommerce-exporter-columns"><?php esc_html_e('Which columns should be exported?', 'lifeline-donation') ?></label>
									</th>
									<td>
										<select id="wpcommerce-exporter-columns" class="wpcommerce-exporter-columns wpcm-enhanced-select" style="width:100%;" multiple name="columns">
											<option value="ID"><?php esc_html_e( 'ID', 'lifeline-donation' ); ?></option>
											<option value="Name"><?php esc_html_e( 'Name', 'lifeline-donation' ); ?></option>
											<option value="Cost"><?php esc_html_e( 'Cost', 'lifeline-donation' ); ?></option>
											<option value="QTY"><?php esc_html_e( 'Qty', 'lifeline-donation' ); ?></option>
											<option value="Total"><?php esc_html_e( 'Total', 'lifeline-donation' ); ?></option>
											<option value="Currency"><?php esc_html_e( 'Currency', 'lifeline-donation' ); ?></option>
											<option value="Status"><?php esc_html_e( 'Status', 'lifeline-donation' ); ?></option>
											<option value="Date Created"><?php esc_html_e( 'Date Created', 'lifeline-donation' ); ?></option>
											<option value="Customer Name"><?php esc_html_e( 'Customer Name', 'lifeline-donation' ); ?></option>
											<option value="Email"><?php esc_html_e( 'Email', 'lifeline-donation' ); ?></option>
											<option value="Gateway"><?php esc_html_e( 'Gateway', 'lifeline-donation' ); ?></option>
											<option value="Recurring"><?php esc_html_e( 'Recurring', 'lifeline-donation' ); ?></option>
											<option value="Recurring Cycle"><?php esc_html_e( 'Recurring Cycle', 'lifeline-donation' ); ?></option>
											<option value="Recurring Frequency"><?php esc_html_e( 'Recurring Frequency', 'lifeline-donation' ); ?></option>
										</select>
									</td>
								</tr>
								<tr>
									<th scope="row">
										<label for="wpcommerce-exporter-types"><?php esc_html_e('Which order status should be exported?', 'lifeline-donation') ?></label>
									</th>
									<td>
										<select id="wpcommerce-exporter-types" class="wpcommerce-exporter-types wpcm-enhanced-select" style="width:100%;" multiple name="status">
											<?php
											$status = array(
												'pending_payment'           => esc_html__( 'Pending Payment', 'lifeline-donation' ),
												'processing'                => esc_html__( 'Processing', 'lifeline-donation' ),
												'hold'                      => esc_html__( 'On Hold', 'lifeline-donation' ),
												'completed'                 => esc_html__( 'Completed', 'lifeline-donation' ),
												'cancelled'                 => esc_html__( 'Cancelled', 'lifeline-donation' ),
												'refunded'                  => esc_html__( 'Refunded', 'lifeline-donation' ),
												'failed'                    => esc_html__( 'Failed', 'lifeline-donation' ),
											);
								...
								<tr>
									<th scope="row">
										<label for="wpcommerce-exporter-date"><?php esc_html_e('Start Date', 'lifeline-donation') ?></label>
									</th>
									<td>
								...
								<tr>
									<th scope="row">
										<label for="wpcommerce-exporter-date"><?php esc_html_e('End Date', 'lifeline-donation') ?></label>
									</th>
									<td>
					...
					<div class="wpcm-actions">
						<button type="submit" class="wpcommerce-exporter-button button button-primary">
							...
							<?php esc_html_e('Generate CSV', 'lifeline-donation') ?>
						</button>
					</div>
				</form>
			</div>
	...
	public static function order_detail( $order ) {
		_deprecated_function( __FUNCTION__, '1.0.7.3', esc_html__( 'No replacement', 'lifeline-donation' ) );
	...
	public static function order_data( $order ) {
		...
		$meta_data = [
			[
				'label' => esc_html__('Gateway', 'lifeline-donation'),
				'value'	=> ($gateway) ? ucwords($gateway->meta_value) : ''
			],
			[
				'label' => esc_html__('Total', 'lifeline-donation'),
				'value'	=> ($total) ? webinane_cm_price_with_symbol($total->meta_value) : '0.00'
			]
		];
	...
	public static function custom_post_status() {
		...
		register_post_status(
			...
			array_merge(
				array(
					'label'                     => _x( 'Processing ', 'post status label', 'lifeline-donation' ),
					'label_count'               => _n_noop( 'Processing <span class="count">(%s)</span>', 'Processing <span class="count">(%s)</span>', 'lifeline-donation' ),
		...
		register_post_status(
			...
			array_merge(
				array(
					'label'                     => _x( 'Pending Payment ', 'post status label', 'lifeline-donation' ),
					'label_count'               => _n_noop( 'Pending Payment <span class="count">(%s)</span>', 'Pending Payment <span class="count">(%s)</span>', 'lifeline-donation' ),
		...
		register_post_status(
			...
			array_merge(
				array(
					'label'                     => _x( 'On Hold ', 'post status label', 'lifeline-donation' ),
					'label_count'               => _n_noop( 'On Hold <span class="count">(%s)</span>', 'On Hold <span class="count">(%s)</span>', 'lifeline-donation' ),
		...
		register_post_status(
			...
			array_merge(
				array(
					'label'                     => _x( 'Completed ', 'post status label', 'lifeline-donation' ),
					'label_count'               => _n_noop( 'Completed <span class="count">(%s)</span>', 'Completed <span class="count">(%s)</span>', 'lifeline-donation' ),
		...
		register_post_status(
			...
			array_merge(
				array(
					'label'                     => _x( 'Cancelled ', 'post status label', 'lifeline-donation' ),
					'label_count'               => _n_noop( 'Cancelled <span class="count">(%s)</span>', 'Cancelled <span class="count">(%s)</span>', 'lifeline-donation' ),
		...
		register_post_status(
			...
			array_merge(
				array(
					'label'                     => _x( 'Refunded ', 'post status label', 'lifeline-donation' ),
					'label_count'               => _n_noop( 'Refunded <span class="count">(%s)</span>', 'Refunded <span class="count">(%s)</span>', 'lifeline-donation' ),
		...
		register_post_status(
			...
			array_merge(
				array(
					'label'                     => _x( 'Failed ', 'post status label', 'lifeline-donation' ),
					'label_count'               => _n_noop( 'Failed <span class="count">(%s)</span>', 'Failed <span class="count">(%s)</span>', 'lifeline-donation' ),
	...
	public static function save_admin_orders_field() {
		...
		if ( ! current_user_can( 'manage_options' ) ) {
			wp_send_json( array( 'message' => esc_html__( 'You are not authorized', 'lifeline-donation' ) ), 403 );
		}
		...
		wp_send_json(
			array(
				'message' => esc_html__( 'Successfully updated', 'lifeline-donation' ),
				'cust' => $data,
			)
		);
	}
	...
	public static function order_admin_data() {
		...
		if ( ! $post_id ) {
			wp_send_json( array( 'message' => esc_html__( 'Invalid Post id', 'lifeline-donation' ) ), 403 );
		}
		if ( ! OrderModel::find( $post_id ) ) {
			wp_send_json( array( 'message' => esc_html__( 'No order found for the given ID', 'lifeline-donation' ) ), 403 );
		}
	...
	public static function update_order_general() {
		...
		if ( ! $order ) {
			wp_send_json_error( esc_html__( 'Invalid order data provided', 'lifeline-donation' ) );
		}
		...
		if ( ! is_wp_error( $result ) ) {
			...
			wp_send_json( array( 'message' => esc_html__( 'Order updated successfully', 'lifeline-donation' ) ) );
		}

		wp_send_json_error( array( 'message' => esc_html__( 'Something went wrong', 'lifeline-donation' ) ) );
	}
	...
	public static function update_order_items() {
		...
		if ( ! current_user_can( 'manage_options' ) ) {
			wp_send_json_error( esc_html__( 'You are not authorized to do that', 'lifeline-donation' ) );
		}
		$_post = filter_input_array( INPUT_POST, FILTER_SANITIZE_STRING );
		...
		wp_send_json_success( esc_html__( 'Item is updated successfully', 'lifeline-donation' ) );
	...
	public static function admin_add_new_item() {
		...
		if ( ! $post ) {
			wp_send_json_error( esc_html__( 'Product doesn\'t exist', 'lifeline-donation' ) );
		}
		...
		if ( ! $price ) {
			wp_send_json_error( esc_html__( 'Product pricie is not available', 'lifeline-donation' ) );
		}
		...
		if ( ! $exists ) {
			...
			wp_send_json_error( esc_html__( 'Item is already in order, please update its quantity', 'lifeline-donation' ) );
		}

		$order_data = self::order_data( $order );
		wp_send_json_success(
			array(
				'message' => esc_html__( 'Item is updated successfully', 'lifeline-donation' ),
				'order' => $order_data,
			)
		);
	}
	...
	public static function admin_delete_order() {
		...
		wp_send_json_success( array( 'message' => esc_html__( 'Note deleted successfully', 'lifeline-donation' ) ) );
	}
	...
	public static function cpt_columns( $columns ) {
		unset( $columns['date'] );
		$columns['title'] = esc_html__( 'Donor', 'lifeline-donation' );
		$columns['total'] = esc_html__( 'Total', 'lifeline-donation' );
		$columns['email'] = esc_html__( 'Email', 'lifeline-donation' );
		$columns['gateway'] = esc_html__( 'Gateway', 'lifeline-donation' );
		$columns['number_itmes'] = esc_html__( 'Number of Items', 'lifeline-donation' );
		$columns['date'] = esc_html__( 'Date', 'lifeline-donation' );
		return $columns;
	}
		...
		switch ( $column ) {
			...
			case 'total':
				...
				if ( $order ) {
					...
					echo wp_kses_post( webinane_cm_price_with_symbol( $total ) );
				} else {
					echo '0';
				}
				// code...
	...
	public static function give_refund() {
		...
		if ( ! current_user_can( 'manage_options' ) ) {
			wp_send_json_error( array( 'message' => esc_html__( 'You have no permissions to do that', 'lifeline-donation' ) ) );
		}
		$order = webinane_set( $_post, 'order' );
		...
		if ( is_object( $gateway ) ) {
			if ( $gateway->is_active() ) {
				...
				wp_send_json_success( array( 'message' => esc_html__( 'Refund is processed successfully', 'lifeline-donation' ) ) );
			} else {
				wp_send_json_error( array( 'message' => esc_html__( 'Gateway is not enabled', 'lifeline-donation' ) ) );
			}
		} else {
			wp_send_json_error( array( 'message' => esc_html__( 'Invalid gateway', 'lifeline-donation' ) ) );
		}
	}
}
