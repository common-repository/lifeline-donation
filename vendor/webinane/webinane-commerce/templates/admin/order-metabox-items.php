...
<div class="wpcm-order-items">
	...
	<table class="wpcm-table" style="width: 100%;">
		<thead>
			<tr>
				<th colspan="2" style="width: 60%"><?php esc_html_e( 'Item', 'lifeline-donation' ); ?></th>
				<th><?php esc_html_e( 'Cost', 'lifeline-donation' ); ?></th>
				<th><?php esc_html_e( 'Qty', 'lifeline-donation' ); ?></th>
		...
		<tbody>
			<?php foreach( $order->order_items as $item ) : ?>
				<tr>
					<td><?php esc_html_e( 'Image', 'lifeline-donation' ) ?></td>
