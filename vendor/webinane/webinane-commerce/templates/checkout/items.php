			...
			<table class="wpcm-table">
				<thead class="wpcm-sec-titlebar wpcm-cart-heading">
		            <tr class="wpcm-d-flex">
		                <th class="wpcm-col-6"><?php esc_html_e('Item', 'lifeline-donation' ); ?></th>
		                <th class="wpcm-col-2"><?php esc_html_e('Cost', 'lifeline-donation' ); ?></th>
		                <th class="wpcm-col-2"><?php esc_html_e('Qty', 'lifeline-donation' ); ?></th>
		                <th class="wpcm-col-2"><?php esc_html_e('Total', 'lifeline-donation' ); ?></th>
		            </tr>
		        </thead>
		        <tbody>
