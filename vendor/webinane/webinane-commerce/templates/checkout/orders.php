<div class="wpcm-order-review">
	<div class="wpcm-edit-order">
		<h4><?php esc_html_e('Your Order', 'lifeline-donation' ); ?></h4>
	</div>
	<ul class="wpcm-order-review-table">

		<li class="wpcm-cart-subtotal wpcm-tbl-list">
			<span class="wpcm-tbl-col1"><?php esc_html_e('Subtotal', 'lifeline-donation' ); ?></span>
	...
	<div class="wpcm-checkout-payment">
		...
		<div class="wpcm-place-order">
			<a href="#" title="<?php esc_html_e('Place Order', 'lifeline-donation' ); ?>" @click.prevent="checkout">
				<?php esc_html_e('Place Order', 'lifeline-donation' ); ?>
